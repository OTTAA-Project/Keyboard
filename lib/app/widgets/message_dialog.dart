...
import 'package:keyboard/app/widgets/animated_dialog.dart';
      ...
      child: Column(
        ...
        children: [
          Padding(
            ...
            child: Text(
              title,
              style: theme.headline5!.copyWith(fontWeight: FontWeight.bold, color: Colors.white),
            ),
          ),
          SelectableText(
            message,
            textAlign: TextAlign.center,
            style: theme.subtitle2!.copyWith(fontWeight: FontWeight.w300, color: Colors.white),
          )
        ],
      ),
    );
