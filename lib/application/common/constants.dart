...
const kKeyboardLayouts = {
  KeyboardLayout.qwerty: 'Layout based on the QWERTY keyboard, the most common keyboard layout in the world.',
  KeyboardLayout.abc: 'Layout based on the alphabet. The letters are arranged in alphabetical order.',
  KeyboardLayout.keypad: 'Layout based on old phones. The letters are grouped on groups of 3 and are arranged in aplhabetical order.',
};
